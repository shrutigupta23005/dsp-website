      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-[#0A0A0A] relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-white/40 max-w-sm mx-auto">
            Create your account to unlock the full catalog, save favorites, and get personalized recommendations.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-background-secondary">
        ...
        >
          ...
          <p className="text-text-muted mb-8">
            Join thousands of footwear enthusiasts.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm font-medium text-text-primary mb-1.5">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-text-muted" />
                <input
                  id="confirm-password"
